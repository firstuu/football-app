	...
	return (
		<div className=''>
			<div className='text-center flex w-full lg:mx-5' >
                ...
                <h1 className=' w-1/4 text-center font-bold text-2xl hidden lg:block'>Popular News</h1>
            ...
            <h1 className='text-center font-bold text-2xl lg:hidden block mt-2'>Popular News</h1>
            <div className='mx-auto'><Videos/></div>
            </div>
