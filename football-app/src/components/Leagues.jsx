...
const Leagues = props => {
	const url = `https://apiv2.allsportsapi.com/football/?&met=Topscorers&leagueId=${props.league}&APIkey=e49388aaf51b9ca2a9d81095fc9eb0a17b1c2fed7b621c890b7e1d1ec81d5c8b`
		...
		<div className='md:w-[90%] h-full bg-gray-900 py-10  rounded-xl mx-auto'>
			...
			<div className='flex flex-col md:flex-row space-y-5 md:space-y-0 md:space-x-4 w-[90%] mx-auto'>
				...
				<img
					src={props.logo}
					alt=''
					className=' md:h-60 h-[500px] w-30 sm:w-25 lg::w-auto px-auto'
				/>
			</div>
		</div>
	)
